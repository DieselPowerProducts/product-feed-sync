...
const pipeline = [
  {
    ...
    body: "Fetch active, published, and eligible products from Shopify, then filter out excluded tags, bundles, warranties, Loop products, return labels, Google_Exclude items, and variants missing critical feed data.",
  },
  {
