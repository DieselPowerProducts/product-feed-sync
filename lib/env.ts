...
export const env = {
  ...
  googleContentLanguage: process.env.GOOGLE_CONTENT_LANGUAGE ?? "en",
  googleFeedLabel: process.env.GOOGLE_FEED_LABEL ?? "US",
  googleFeedCurrency: process.env.GOOGLE_FEED_CURRENCY ?? "USD",
...
export function getConfigurationStatus() {
  ...
  return {
    ...
    dashboardPassword: hasValue(env.dashboardPassword),
    dashboardSessionSecret:
      hasValue(env.dashboardSessionSecret) || hasValue(env.shopifyClientSecret),
    shopifyReady,
